...
const Hero = () => {
  return (
    <section className="w-full h-[90vh] bg-cover bg-no-repeat text-white sm:px-16 lg:px-32 pt-20 bg-center md:bg-[url('/image-header.jpg')] lg:bg-[url('/image-hero.jpg')]">

...
const Hero = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center h-[90vh] bg-cover bg-center text-white    pt-20  sm:bg-[url('/image-header.jpg')] lg:bg-[url('/image-hero.jpg')] ">
      <section className="container mx-auto h-full px-8 lg:px-16">
        ...
        <div className="flex items-center justify-center size-full lg:justify-normal">
          <div className="flex flex-col gap-4  max-w-[396px] md:items-center lg:items-start">
            ...
            <p className="uppercase text-[56px] font-bold font-manrope sm:text-center lg:text-left ">
              XX99 Mark II Headphones
            </p>
            <p className=" md:max-w-80 text-sm text-neutral-50/80 sm:text-center lg:text-left">
